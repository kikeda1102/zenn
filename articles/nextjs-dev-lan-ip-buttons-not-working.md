---
title: "Next.jsのdev環境にLANからアクセスするとボタンが反応しない原因と解決策"
emoji: "🔧"
type: "tech"
topics: ["nextjs"]
published: true
...
Next.js での開発中にこの問題に遭遇しました。
分かってしまえば当たり前ともいえることですが個人的に原因特定にそこそこ時間がかかったため、記事にまとめておきたいと思います。
...
Network 側のアドレス (http://172.20.10.4:3000) を Cmd + クリックしてブラウザで開いたところ、ページ自体は正常に表示された。
...
公式ドキュメントに辿り着けばすぐわかることなのですが、半日ぐらい調べてました。。。
ログをみよう！
